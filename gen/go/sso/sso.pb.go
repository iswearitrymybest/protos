...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // email is the email address of the user.
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password is the password of the user
}
...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // user_id is the ID of the newly registered user.
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`              // email is the email address of the user to login
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`        // password is the password of the user to login
	AppId    string `protobuf:"bytes,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // app_id is the ID of the application to login
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // token is the auth token of the logged in user.
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // user_id is the ID of the user to check
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // is_admin is true if the user is an admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1f, 0x5a, 0x1d, 0x69, 0x73, 0x77, 0x65, 0x61, 0x72, 0x69,
	0x74, 0x72, 0x79, 0x6d, 0x79, 0x62, 0x65, 0x73, 0x74, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
